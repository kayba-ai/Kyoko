"""Example KYOKO_REPLAY_HOOK for Hermes-style profile/task workflows.

This example is dependency-free. In a real Hermes integration, replace
run_hermes_replay() with a Hermes task/profile replay using mocked or sandboxed
...
def replay(request: dict[str, Any]) -> dict[str, Any]:
    output_run_id = "run_hermes_replay_001"
    source_id = "source_hermes_replay_example"
    root_span_id = "span_hermes_replay_root_001"
    ...
    return {
        ...
        "note": "Hermes example replay retried fetch_source before handing the task back to writer.",
    }
...
def _source_events(
    *,
    ...
    return {
        ...
        "sources": [
            {
                ...
                "kind": "hermes-python",
                "display_name": "Hermes replay hook example",
                "status": "active",
                "adapter_version": "kyoko.example.hermes_replay_hook.v0",
        ...
        "runs": [
            {
                ...
                "profile_id": "profile_news_research_001",
                "source_id": source_id,
                "external_id": "hermes-replay-run-001",
                "root_span_id": root_span_id,
                ...
                "input_ref": "input://hermes/replay/news-topic",
                "output_ref": "output://hermes/replay/news-topic",
                "summary": "Replay completed after retrying the transient source fetch timeout.",
                "metadata_json": {"replay_of_run_id": replay_of_run_id, "hermes.profile": "researcher"},
            }
        ],
        "spans": [
            {
                ...
                "source_id": source_id,
                "external_id": "hermes-replay-root",
                "parent_span_id": None,
                ...
                "output_ref": "output://hermes/replay/news-topic",
                "usage_json": {},
                "attributes_json": {"replay_of_run_id": replay_of_run_id, "hermes.profile": "researcher"},
                "raw_ref": None,
            },
            {
                "id": retry_span_id,
                "run_id": output_run_id,
                "source_id": source_id,
                "external_id": "hermes-fetch-source-retry",
                ...
                "input_ref": "input://hermes/replay/fetch-source",
                "output_ref": "output://hermes/replay/fetch-source",
                "usage_json": {},
                "attributes_json": {
                    ...
                    "hermes.task": "task_research_topic_001",
                },
                "raw_ref": None,
            },
        ],
        "handoffs": [
            {
                "id": "handoff_hermes_replay_research_to_writer_001",
                "profile_id": "profile_news_research_001",
                "source_id": source_id,
                ...
                "span_id": None,
                "kind": "agent_handoff",
                "reason_ref": "reason://hermes/replay/fetch-recovered",
                "payload_ref": "payload://hermes/replay/source-complete",
        ...
        "timeline_events": [
            {
                "id": "event_hermes_replay_fetch_retry_success_001",
                "profile_id": "profile_news_research_001",
                "source_id": source_id,
                "entity_type": "span",
                ...
                "agent_identity_id": "agent_researcher_001",
                "payload_ref": "output://hermes/replay/fetch-source",
