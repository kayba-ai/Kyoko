"""Example KYOKO_REPLAY_HOOK for Pydantic AI style agent runs.

This example is dependency-free. In a real Pydantic AI app, replace
run_pydantic_ai_replay() with an agent run using mocked or sandboxed tools,
...
def replay(request: dict[str, Any]) -> dict[str, Any]:
    output_run_id = "run_pydantic_ai_replay_001"
    source_id = "source_pydantic_ai_replay_example"
    root_span_id = "span_pydantic_ai_replay_root_001"
    ...
    return {
        ...
        "note": "Pydantic AI example replay retried the transient source fetch with mocked tool behavior.",
    }
...
def _source_events(
    *,
    ...
    return {
        ...
        "sources": [
            {
                ...
                "display_name": "Pydantic AI replay hook example",
                "status": "active",
                "adapter_version": "kyoko.example.pydantic_ai_replay_hook.v0",
        ...
        "runs": [
            {
                ...
                "profile_id": "profile_news_research_001",
                "source_id": source_id,
                "external_id": "pydantic-ai-replay-run-001",
                "root_span_id": root_span_id,
                ...
                "input_ref": "input://pydantic-ai/replay/news-topic",
                "output_ref": "output://pydantic-ai/replay/news-topic",
        ...
        "spans": [
            {
                ...
                "source_id": source_id,
                "external_id": "pydantic-ai-replay-root",
                "parent_span_id": None,
                ...
                "input_ref": "input://pydantic-ai/replay/news-topic",
                "output_ref": "output://pydantic-ai/replay/news-topic",
                "usage_json": {"input_tokens": 128, "output_tokens": 54},
                "attributes_json": {
            ...
            },
            {
                ...
                "run_id": output_run_id,
                "source_id": source_id,
                "external_id": "pydantic-ai-fetch-source-retry",
                ...
                "input_ref": "input://pydantic-ai/replay/fetch-source",
                "output_ref": "output://pydantic-ai/replay/fetch-source",
                "usage_json": {},
                "attributes_json": {
        ...
        "handoffs": [
            {
                "id": "handoff_pydantic_ai_replay_research_to_writer_001",
                "profile_id": "profile_news_research_001",
                "source_id": source_id,
                ...
                "span_id": None,
                "kind": "agent_handoff",
                "reason_ref": "reason://pydantic-ai/replay/fetch-recovered",
                "payload_ref": "payload://pydantic-ai/replay/source-complete",
        ...
        "timeline_events": [
            {
                "id": "event_pydantic_ai_replay_fetch_retry_success_001",
                "profile_id": "profile_news_research_001",
                "source_id": source_id,
                "entity_type": "span",
                ...
                "agent_identity_id": "agent_researcher_001",
                "payload_ref": "output://pydantic-ai/replay/fetch-source",
